module characters(select,vec_char);
    ...
    wire [39:0]vect_sym_plus;
    wire [39:0]vect_sym_minus;
    wire [39:0]vect_sym_mult;
    wire [39:0]vect_sym_and;
    wire [39:0]vect_sym_or;
    wire [39:0]vect_sym_arrow;
	...
	assign vect_sym_plus = {5'b00000,5'b00000,5'b00100,5'b01110,5'b00100,5'b00000,5'b00000,5'b00000};
    assign vect_sym_minus = {5'b00000,5'b00000,5'b00000,5'b01110,5'b00000,5'b00000,5'b00000,5'b00000};
    assign vect_sym_and = {5'b00000,5'b10110,5'b10101,5'b00010,5'b00101,5'b01001,5'b00110};
    assign vect_sym_mult = {5'b00000,5'b00100,5'b10101,5'b01110,5'b10101,5'b00100,5'b00000,5'b00000};
    assign vect_sym_or = {5'b00000,5'b00100,5'b00100,5'b00100,5'b00100,5'b00100,5'b00000,5'b00000};
    assign vect_sym_arrow = {5'b00000,5'b00000,5'b00100,5'b00110,5'b11111,5'b00110,5'b00100,5'b00000};
	...
	always@(*)
		...
		case(select)
			...
			8'd125:vec_char=vect_sym_plus;
			8'd127:vec_char=vect_sym_mult;
			8'd126:vec_char=vect_sym_minus;
			8'd128:vec_char=vect_sym_and;
			8'd129:vec_char=vect_sym_or;
            8'd130:vec_char=vect_sym_arrow;


			default :vec_char=vect_char_space;//punto
